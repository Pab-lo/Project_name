...
def rnn_run(label_name, num_lags, num_epochs, diff_mode, smoothing = False, scaling = False, compression_mode = None):
    ...
    model = ForecastingModel(data_dim = data_dim, hidden_dim = 16, num_layers = 2, model_type = 'GRU', drop_prob = 0.5)
...
#all_pairs = ["AAPL", "ABT", "ADBE", "ADP", "AMAT", "AMD", "AMGN", "AXP", "BA", "BAC", "BMY", "C", "CAT", "CMCSA", "COST", "CVS", "CVX", "DE", "DHR", "DIS", "GE", "HD", "HON", "IBM", "INTC", "JNJ", "JPM", "KO", "LLY", "LMT", "LOW", "MCD", "MDT", "MMM", "MO", "MRK", "MSFT", "NEE", "NKE", "ORCL", "PEP", "PFE", "PG", "RTX", "SCHW", "SPGI", "SYK", "T", "TGT", "TJX", "TMO", "TXN", "UNH", "UNP", "VZ", "WFC", "WMT", "XOM"]
